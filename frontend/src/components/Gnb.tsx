...
export default function Gnb() {
  ...
  return (
    <>
      ...
      {/* Credit Modal - Moved OUTSIDE of nav to prevent clipping */}
      {showHistory && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-md p-4 overflow-y-auto">
          <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl p-8 relative animate-in fade-in zoom-in duration-200">
            <button
